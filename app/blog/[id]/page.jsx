...
import Mee from "@/images/rendy.png";
    ...
    <div className="py-20 bg-cover">
      ...
      >
        ...
        <div className="relative p-10 flex justify-center flex-col w-full items-center">
          ...
          <div className="w-full  bg-cover flex flex-col justify-center items-center gap-4 text-gray-50">
            <Image
              src={Mee}
              width={300}
              height={300}
              alt="author"
              className="rounded-full w-52 h-52 object-cover border-sky-400 border-4 mt-5"
            />
